...
class Default_Form_Manage_EmailAddresssettings extends Zend_Form
{
	...
	public function init()
	{
		...
		$tag = new  Zend_Form_Element_Text('spam_tag', array(
		...
		$blockbounces = new Zend_Form_Element_Checkbox('quarantine_bounces', array(
	    ...
	    $this->addElement($blockbounces);
            ...
            $bypassfiltering = new Zend_Form_Element_Checkbox('bypass_filtering', array(
		...
		$summary_to = new  Zend_Form_Element_Text('summary_to', array(
