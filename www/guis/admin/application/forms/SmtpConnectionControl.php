...
class Default_Form_SmtpConnectionControl extends ZendX_JQuery_Form
{
    ...
    public function init()
    {
        ...
        $allowconnect = new Zend_Form_Element_Textarea('smtp_conn_access', [
        ...
        $allowrelay = new Zend_Form_Element_Textarea('relay_from_hosts', [
        ...
        if ($user_role != 'administrator') {
            $allowrelay->setAttrib('disabled', true);
            $allowrelay->setAttrib('readonly', true);
        }

        $this->addElement($allowrelay);

        $allow_relay_for_unknown_domains = new Zend_Form_Element_Checkbox('allow_relay_for_unknown_domains', [
        ...
        $relay_refused_to_domains = new Zend_Form_Element_Textarea('relay_refused_to_domains', [
        ...
        $rejecthosts = new Zend_Form_Element_Textarea('host_reject', [
        ...
        require_once 'Validate/EmailList.php';
        $rejectsenders = new Zend_Form_Element_Textarea('sender_reject', [
        ...
        $rejectusers = new Zend_Form_Element_Textarea('user_reject', [
        ...
        require_once 'Validate/EmailList.php';
        $rejectrecipient = new Zend_Form_Element_Textarea('recipient_reject', [
