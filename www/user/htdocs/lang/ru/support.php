...
$txt['SFALSENEGSUBTITLE'] = "Вы получили сообщение, которое вы считаете спамом?";
$txt['SVERIFYPASS'] = "Убедитесь, что сообщение было обработано фильтрами Mailcleaner, просмотрев заголовки электронной почты.";
$txt['SMCLOGTITLE'] = "В заголовках вы увидите следующие строки, в которых упоминается Mailcleaner:";
$txt['SMCFILTERINGLOG'] = "Result of filtering: X-Mailcleaner-spamscore: oooo";
$txt['SFALSENEGTUTOR'] = "Если вы действительно считаете, что сообщение является спамом, перешлите его на адрес spam@mailcleaner.net, или, если ваша почтовая программа позволяет это сделать, выберите «Переслать как вложение», чтобы сохранить заголовки писем неповрежденными. Мы проанализируем содержание сообщения и соответствующим образом адаптируем критерии фильтрации почты, чтобы все пользователи Mailcleaner извлекли выгоду из анализа.";
$txt['SFALSEPOSSUB1TITLE'] = "Вы не получили сообщение, которое должны были получить?";
$txt['SFALSEPOSSUB1'] = "Вы можете проверить заблокировано ли сообщение фильтром Mailcleaner через веб-интерфейс пользователя в разделе \"Карантин\". Если вы не найдете его в списке карантина, проверьте следующие пункты:";
$txt['SFALSEPOSSUB1POINT1'] = "адрес получателя, используемый отправителем, корректный";
$txt['SFALSEPOSSUB1POINT2'] = "сообщение уже обработано (обработка может занять несколько минут)";
$txt['SFALSEPOSSUB2TITLE'] = "Сообщение было расценено как спам и вы не понимаете почему?";
$txt['SFALSEPOSSUB3TITLE'] = "Списки рассылки";
$txt['SFALSEPOSSUB3'] = "Иногда списки рассылки блокируются фильтрами Mailcleaner. Это связано с их форматированием, которое часто очень похоже на спам. Вы можете запросить анализ этих сообщений, как описано выше, и наш аналитический центр позаботится о том, чтобы поместить такие списки рассылки в белые списки, чтобы предотвратить их блокировку в будущем.";
$txt['SOTHERTITLE'] = "ДРУГИЕ ПРОБЛЕМЫ";
$txt['SOTHER'] = "У вас есть проблема другого типа с приемом электронной почты и вам не помогли вышеуказанные процедуры? Если это так, обратитесь в Mailcleaner Analysis Center, заполнив эту форму.";
$txt['DOCTITLE'] = "Справка по интерфейсу пользователя";
$txt['WEBDOCTITLE'] = "Онлайн документация";
$txt['SFALSEPOSSUB2'] = "Из списка карантина вы можете просмотреть критерии, которые Mailcleaner использовал для оценки сообщения как спам, нажав на <img src=\"/templates/$template/images/support/reasons.gif\" align=\"middle\" alt=\"\">. Если вы считаете, что эти критерии ошибочны, вы можете запросить анализ в нашем аналитическом центре, нажав на <img src=\"/templates/$template/images/support/analyse.gif\" align=\"middle\" alt=\"\">. Также вы можете освободить сообщение, нажав на <img src=\"/templates/$template/images/support/force.gif\" align=\"middle\" alt=\"\">.";
$txt['WEBDOC'] = "<ul><li>Ищите больше информации и документацию на нашем сайте:
<a href=\"http://wiki2.mailcleaner.net/doku.php/documentation:userfaq\" target=\"_blank\">Mailcleaner user documentation</a>
</li></ul>";
$txt['FAQTITLE'] = "Понимание Mailcleaner";
$txt['FAQ'] = "
               <ul>
