...
<head>
    ...
    <style>
        ...
        header {
            ...
            background: #741864;
            /* Old browsers */
            background: -moz-linear-gradient(-45deg, #741864 0%, #7db9e8 100%);
            /* FF3.6-15 */
            background: -webkit-linear-gradient(-45deg, #741864 0%, #7db9e8 100%);
            /* Chrome10-25,Safari5.1-6 */
            background: linear-gradient(135deg, #741864 0%, #7db9e8 100%);
            /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
            filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#741864', endColorstr='#7db9e8', GradientType=1);
